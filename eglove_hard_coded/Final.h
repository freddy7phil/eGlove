...
//Current no. of Alphabets
#define ALPHA_COUNT 26

//Maximum no. of Alphabets
#define MAX_ALPHA_COUNT 50

//Maximum no. of Sensors
#define MAX_SEN_COUNT 5
...
//Structure to Store the Sensor Range for aach Alphabet
struct alphabet{
  struct Euler minS[MAX_SEN_COUNT];
  struct Euler maxS[MAX_SEN_COUNT];
}alphabets[MAX_ALPHA_COUNT];
